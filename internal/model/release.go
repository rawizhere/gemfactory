...
type Release struct {
	...
	DisplayArtist string    `bun:"display_artist" json:"display_artist,omitempty"`
	Title         string    `bun:"title,notnull" json:"title"`
	TitleTrack    string    `bun:"title_track" json:"title_track"`
	AlbumName     string    `bun:"album_name" json:"album_name"`
	MV            string    `bun:"mv" json:"mv"`
	Spotify       string    `bun:"spotify" json:"spotify"`
